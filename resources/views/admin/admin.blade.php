    ...
    @section('content')
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Categorías ({{ $totalCats }})</h1>
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a href="{{ route('addCategory') }}" class="btn btn-info">Añadir</a>
          </div>
        </div>
      </div>
          ...
          <tbody>
            @if($items->count())  
              ...
              <tr>
                ...
                <td><a class="btn btn-sm btn-info" href="{{ route('editcategory', ['id' => $item->id]) }}">Editar</a></td>
                <td>
