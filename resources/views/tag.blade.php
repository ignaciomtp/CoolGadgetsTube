    ...
    <main class="album pt-4 bg-light">
						...
						<div class="col-sm-12 col-md-6 col-lg-4">
						  <div class="card mb-4 sombra">
						    ...
						    <div class="card-body">
						    	...
						    	@if($prod->video)
						    	<div class="itemImg mb-3" onmouseover="showVideo({{ $prod->id }})" onmouseout="hideVideo({{ $prod->id }})">
						    		
						    		<div class=" " id="vid-{{ $prod->id }}">
						    			<video id="video{{ $prod->id }}" src="{{ asset('vid/products/' . $prod->video) }}" muted="muted" preload="none" width="310" poster="{{ asset('img/play4.png') }}"></video>
						    		</div>
		...
		<div class="dark-back text-center pt-3 pb-3 mb-0">
			<div class="container">

				<input id="tag" value="{{ $tg->slug }}" >
